...
const logController = { sourceTypes: sourceTypes };
logController.parseLogs = (req, res, next) => {
    const pods = {};
    let parsedUsername;
    let parsedProjectName;
    // const LOG_DIR = "/fluentd/logs";
    fs_1.default.readFile('/Users/charlesfrancofranco/Codesmith/OSP/KataLog/logs/Example.log', 'utf-8', (err, readData) => {
        if (err) {
...
logController.getLogs = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const logs = yield logModel_1.default.find({ project_id: req.params.selectedProject });
