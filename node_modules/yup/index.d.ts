...
type ResolveFlags<T, F extends Flags, D = T> = Preserve<F, 's'> extends never ? Extract<F, 'd'> extends never ? T : D extends undefined ? T : Defined<T> : never;
...
declare abstract class Schema<TType = any, TContext = any, TDefault = any, TFlags extends Flags = ''> implements ISchema<TType, TContext, TFlags, TDefault> {
    ...
    protected _cast(rawValue: any, _options: CastOptions$1<TContext>): any;
...
type TypeFromShape<S extends ObjectShape, _C> = {
    [K in keyof S]: S[K] extends ISchema<any, any> ? S[K]['__outputType'] : S[K] extends Reference<infer T> ? T : unknown;
};
