...
export function useNumberInput(parameters) {
  ...
  var _React$useState2 = React.useState(valueProp != null ? valueProp : defaultValueProp),
    value = _React$useState2[0],
    setValue = _React$useState2[1]; // the (potentially) dirty or invalid input value
  var _React$useState3 = React.useState(value ? String(value) : undefined),
    dirtyValue = _React$useState3[0],
    setDirtyValue = _React$useState3[1];
