...
export declare const getCoordinatesOfGrid: (ticks: Array<TickItem>, min: number, max: number, syncWithTicks: Boolean) => number[];
...
export declare const getStackedDataOfItem: <StackedData>(item: ReactElement, stackGroups: Record<string | number | symbol, GenericChildStackGroup<StackedData>>) => StackedData;
